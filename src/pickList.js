   ...
   $.fn.pickList = function (options) {
      ...
      this.init = function () {
         var pickListHtml =
                 ...
                 " </div>" +
                 " <div class='col-sm-2 div-button-vincular-perfil'>" +
                 "	<button  class='pAdd button-vincular-perfil '>" + opts.add + "</button>" +
				  " <br /> " +
                 // "      <button  class='pAddAll btn btn-primary btn-sm'>" + opts.addAll + "</button>" +
                 "	<button  class='pRemove button-vincular-perfil'>" + opts.remove + "</button>" +
